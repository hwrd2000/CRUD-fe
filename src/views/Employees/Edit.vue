  ...
  <div class="container mt-5">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="mb-3">
          <button type="button" @click="updateEmployees" class="btn btn-primary">Update</button>
        </div>
      </div>
    </div>
  </div>
...
export default{
  ...
  methods: {
    ...
    getEmployeesData(employeesId){

      axios.get(`http://127.0.0.1:8000/api/employees/${employeesId}/edit`)
      .then(res => {
        console.log(res.data.employees);

        this.model.employees = res.data.employees;
      })
      ...
      updateEmployees(){
          ...
          var mythis = this;
          axios.put(`http://127.0.0.1:8000/api/employees/${this.employeesId}/edit`, this.model.employees)
          .then(res =>{
  ...
  axios.get('http://127.0.0.1:8000/api/departments')
    ...
    this.employeesId = this.$route.params.id;
    this.getEmployeesData(this.$route.params.id);
  ...
  //added this from chatgpt
    handleFileUpload(event) {
        ...
        if (file){
          this.model.employees.photo = URL.createdObjectURL(file);
        }
      },
}
